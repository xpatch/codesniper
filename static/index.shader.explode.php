...
function init() {
	...
	*/
	...
	app.materials['shaderX'] = new THREE.ShaderMaterial({
		uniforms: { 
			tExplosion: { type: "t", value: THREE.ImageUtils.loadTexture( 'explosioni.png' ) },
	...
	for( var o1 = 0; o1 < 224; o1++ ) {
		...
		//if( (o1 % per_ring) == 0 ) scene.add( new THREE.Line( new THREE.CircleGeometryZ( r, per_ring ), app.materials.sphere ) );	
